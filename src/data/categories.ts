...
export const DEFAULT_CATEGORIES: Category[] = [
  ...
  { id: '10', name: 'Equipment Purchase', type: 'reinvestment', isDefault: true },
  { id: '11', name: 'Business Expansion', type: 'reinvestment', isDefault: true },
  { id: '12', name: 'Stock Reinvestment', type: 'reinvestment', isDefault: true },
  { id: '13', name: 'Marketing Investment', type: 'reinvestment', isDefault: true },
  { id: '14', name: 'Other Reinvestment', type: 'reinvestment', isDefault: true },
];
